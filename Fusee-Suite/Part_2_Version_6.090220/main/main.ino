...
#define DEFAULT_BOOTLOGO 2 //1 = no bootlogo, 2 = static bootlogo, 3 = (sliding), 4 = (wiping) 5 = (white noise)
#define LOGOS_AVAILABLE 5
#define DEFAULT_SCREENSAVER_ON 1 //1 = active. 0 = inactive.
#define BITMAP_LOGO_ENABLED 1 //1 = active. 0 = inactive.
...
void runOnce()
{
  ...
  EEPROM_BITMAP_BOOTLOGO_ON = BITMAP_LOGO_ENABLED;
