...
int blz_uncompress_sdasset(u8 col1, u8 col2, u8 col3, unsigned char *compData, unsigned int compDataLen, unsigned char *dstData, unsigned int dstSize)
{
	blz_footer footer;
	const blz_footer *compFooterPtr = blz_get_footer(compData, compDataLen, &footer);
	if (compFooterPtr == NULL)
...
int blz_uncompress_bootlogo(u8 col1, u8 col2, u8 col3, u8 col4, u8 col5, u8 col6, unsigned char *compData, unsigned int compDataLen, unsigned char *dstData, unsigned int dstSize)
{
	blz_footer footer;
	const blz_footer *compFooterPtr = blz_get_footer(compData, compDataLen, &footer);
	if (compFooterPtr == NULL)
