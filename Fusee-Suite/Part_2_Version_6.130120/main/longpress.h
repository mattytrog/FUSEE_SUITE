...
#define TRIGGER1 7000
#define TRIGGER2 8000
#define TRIGGER3 9000
#define TRIGGER4 10000
#define TRIGGER5 11000
#define TRIGGER6 12000
...
void cycle_bootlogo() {
...

  {
    ...
    while (digitalRead(VOLUP_STRAP_PIN) == LOW)
    {
      ...
      if (current_tick > TRIGGER5 && current_tick <  TRIGGER6) setLedColor("white");
