## Multiple-press settings versions of Fusee_UF2. Identical to other versions but EEPROM bit changed from 00 to 01(or vise-versa) to enable Multiple-press settings.
